...
public class MadLib
{
	...
	public void loadNouns()
	{
		String s = "";
		try{
		Scanner file = new Scanner(new File("H:\\APCS\\Unit10\\Unit10-2016\\Unit10-Assignments\\nouns.dat"));
	...
	public void loadVerbs()
	{
		String s = "";
		try{
			Scanner file = new Scanner(new File("H:\\APCS\\Unit10\\Unit10-2016\\Unit10-Assignments\\verbs.dat"));
			while (file.hasNextLine())
				{
	...
	public void loadAdjectives()
	{
		...
		try{
			...
			Scanner file = new Scanner(new File("H:\\APCS\\Unit10\\Unit10-2016\\Unit10-Assignments\\adjectives.dat"));
			while (file.hasNextLine())
				{
